...
class ProduitsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'prix' => ['type' => 'decimal', 'length' => 7, 'precision' => 2, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => ''],
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'prix' => 1.5,
                'category_id' => 1,
                'created' => '2021-03-03 21:04:47',
                'modified' => '2021-03-03 21:04:47',
                'deleted' => '2021-03-03 21:04:47',
            ],
        ];
        parent::init();
    }
